...
interface ServiceDetailsStepProps {
  ...
  onUpdateRoomSharingNotice: (accepted: boolean) => void
}
...
export function ServiceDetailsStep({
  ...
  roomSharingNoticeAccepted,
  onUpdateRoomSharingNotice,
        ...
        <div className="rounded-lg p-4 bg-white border border-gray-200">
          ...
          <div className="mt-4 rounded-lg border border-gray-200 bg-white p-4">
            <label className="flex items-start gap-3">
              <input
                type="checkbox"
                checked={roomSharingNoticeAccepted}
                onChange={(event: ChangeEvent<HTMLInputElement>) => onUpdateRoomSharingNotice(event.target.checked)}
            ...
            {!roomSharingNoticeAccepted && (
              <p className="mt-2 text-sm text-red-600">
                Please confirm this notice before continuing to the next step.
              </p>
            )}
          </div>
