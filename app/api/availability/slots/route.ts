...
export async function POST(request: NextRequest) {
  try {
    ...
    const blockedServiceDates: Record<string, string[]> = {
      'relaxation-renewal': ['2026-05-09', '2026-05-10', '2026-08-09', '2026-08-10'],
      'complete-body-care': ['2026-05-09', '2026-05-10', '2026-08-09', '2026-08-10'],
      'massage-creative-escape': ['2026-05-09', '2026-05-10', '2026-08-09', '2026-08-10'],
      'ultimate-relaxation': ['2026-05-09', '2026-05-10', '2026-08-09', '2026-08-10'],
      'massage-facial-bliss': ['2026-05-09', '2026-05-10', '2026-08-09', '2026-08-10'],
    }
